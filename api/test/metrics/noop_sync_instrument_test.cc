...
TEST(Counter, Add)
{
  ...
  EXPECT_NO_THROW(counter->Add(10l, labels, opentelemetry::contxet::Context{}));
  EXPECT_NO_THROW(counter->Add(2l, opentelemetry::contxet::Context{}));
  EXPECT_NO_THROW(
      counter->Add(10l, {{"k1", "1"}, {"k2", 2}}, opentelemetry::contxet::Context{}));
}
